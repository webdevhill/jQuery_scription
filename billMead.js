...
$("#tabs > ul > li > a").click(function(t) {
    t.preventDefault(), $("#tabs > ul > li > a").css({
        background: "#C8D6AF"
    }), $(this).css({
        background: "#F7FFEA"
    });
    ...
    $("#features ul:first-of-type li:nth-child(1)").css({
        ...
        function i() {
            setTimeout(function() {
                ...
                })) : ($("#features ul:first-of-type").remove(), n = $("#features ul:first-of-type").clone(), $("#features").css("top", "0"), $("#features").append(n), e = 0, t = 1, $("#features ul:first-of-type li:nth-child(1)").css({
                    color: "#FF5964",
                    fontWeight: "600"
                }), i())
            }, 1500)
